...
export default function Home() {
  return (
    <main
      className={
        'flex h-screen w-full flex-col items-center space-y-4 bg-gradient-to-b from-light-purple to-light-blue'
      }
    >
      <Image
        src='/img/home/wankul-logo-light.png'
        alt='wankul logo'
        className={'h-auto w-3/4 pt-20'}
        width={300}
        height={0}
        priority={true}
      />
      <div
        id={'wankul-infos'}
        className={
          'flex h-1/5 w-[75%] flex-col items-center justify-center rounded-md border-2 border-dark-purple text-center'
        }
      >
        <p className={'p-2 text-xl text-dark-blue'}>
      ...
      <div
        ...
        className={`relative flex h-1/4 w-[75%] flex-col items-center space-y-2 rounded-md border-2 border-dark 
          bg-yellow-400 p-4 pt-12 text-center text-xl text-dark`}
      >
      ...
      <Image src={'/img/home/down-light.png'} alt={'go down'} width={125} height={400} className={'pt-8'} />
    </main>
  );
}
