...
interface Props {
  rarityName: ReactNode;
  totalCards: ReactNode;
}

export default function RaritySummary({rarityName, totalCards}: Props) {
  const infos: Array<SummaryLogo> = [
    {
      logo: '/img/rarities/details/rarity-light.png',
      name: 'rareté',
      text: rarityName,
    },
    {
      logo: '/img/rarities/details/collection-light.png',
